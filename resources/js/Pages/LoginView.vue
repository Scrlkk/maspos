                ...
                <div class="px-24 h-full flex flex-col justify-center gap-4">
                    <div>
                        ...
                        <div class="text-xl">
                            ...
                            efisien. MASPOS menghadirkan solusi <br />
                            point-of-sale terbaik untuk kemudahan operasional
                            sehari-hari.
                        </div>
                    </div>
                    ...
                    <div
                        class="w-full p-2.5 mt-2 rounded-lg flex justify-center bg-blue-500 text-white"
                    >
                        Masuk
                    </div>
                </div>
